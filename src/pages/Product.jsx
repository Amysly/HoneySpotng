    ...
    <section className="bg-white py-16 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-amber-600 font-bold font-roboto tracking-widest uppercase text-sm mb-2">Nature's Best</h2>
          <h1 className="text-3xl md:text-4xl sm:text-3xl font-black font-roboto text-green-800">
          ...
          {products.map((product) => {
            ...
            return (
              ...
              >
                ...
                <h2 className="text-xl text-green-900 font-bold font-roboto mb-1">
                  {product.name}
                </h2>
                <p className="text-amber-700 text-2xl sm:text-xl font-black font-sans mb-6">
                  {product.price}
                </p>
                ...
                >
                  <button className="w-full bg-green-700 text-white font-bold font-sans py-3 px-6 rounded-xl transition-colors hover:bg-green-800 flex items-center justify-center gap-2">
                    <span>Order</span>
