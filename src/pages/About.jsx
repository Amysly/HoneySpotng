    ...
    <section className="bg-white py-16 px-6 lg:px-20 overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center mb-16">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-3xl md:text-4xl  font-black text-green-800">About Us</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
        ...
        <div className="space-y-6 text-center lg:text-left">
          <h3 className="text-3xl sm:text-2xl font-bold text-green-700">Our Story</h3>
      ...
      {/* Promise Section: Centered Layout */}
      <div className="max-w-4xl mx-auto bg-amber-50 rounded-3xl p-8 md:p-12 text-center shadow-inner">
        <div className="flex justify-center items-center gap-3 mb-6">
          ...
          <h3 className="text-3xl  sm:text-2xl font-bold text-green-700">Our Promise</h3>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="p-4 bg-white rounded-xl shadow-sm">
            ...
            <p className="font-bold text-green-800">100% Pure</p>
          </div>
          <div className="p-4 bg-white rounded-xl shadow-sm">
            <span className="text-3xl block mb-2">🌿</span>
            <p className="font-bold text-green-800">Sustainable</p>
          </div>
          <div className="p-4 bg-white rounded-xl shadow-sm">
            <span className="text-3xl block mb-2">✨</span>
            <p className="font-bold text-green-800">Unprocessed</p>
          </div>
        </div>
      </div>
    </section>
