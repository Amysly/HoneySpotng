      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-6">
            <h1 className="text-5xl md:text-6xl font-black font-sans text-amber-900 leading-tight">
              Pure & <span className="text-amber-600">Natural</span> Honey
            </h1>
            <p className="text-amber-800 font-sans text-xl md:text-2xl font-medium max-w-lg mx-auto lg:mx-0">
